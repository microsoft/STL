...
void test_to_int_ref() { // COMPILE-ONLY
    ...
    static_assert(!reference_constructs_from_temporary<int&, to_int_xvalue<Explicity>>::value);
    static_assert(!reference_constructs_from_temporary<const int&, to_int_xvalue<Explicity>>::value);
    static_assert(reference_constructs_from_temporary<const long&, to_int_xvalue<Explicity>>::value
                  == !static_cast<bool>(Explicity));
    static_assert(!reference_constructs_from_temporary<int&, to_int_prvalue<Explicity>>::value);
    static_assert(reference_constructs_from_temporary<const int&, to_int_prvalue<Explicity>>::value);
    static_assert(reference_constructs_from_temporary<const long&, to_int_prvalue<Explicity>>::value
                  == !static_cast<bool>(Explicity));

    static_assert(!reference_constructs_from_temporary_v<int&, to_int_lvalue<Explicity>>);
    static_assert(!reference_constructs_from_temporary_v<const int&, to_int_lvalue<Explicity>>);
    static_assert(
        reference_constructs_from_temporary_v<const long&, to_int_lvalue<Explicity>> == !static_cast<bool>(Explicity));
    static_assert(!reference_constructs_from_temporary_v<int&, to_int_xvalue<Explicity>>);
    static_assert(!reference_constructs_from_temporary_v<const int&, to_int_xvalue<Explicity>>);
    static_assert(
        reference_constructs_from_temporary_v<const long&, to_int_xvalue<Explicity>> == !static_cast<bool>(Explicity));

    static_assert(!reference_constructs_from_temporary_v<int&, to_int_prvalue<Explicity>>);
    static_assert(reference_constructs_from_temporary_v<const int&, to_int_prvalue<Explicity>>);
    static_assert(
