...
#if defined(__cpp_lib_concepts) && !defined(__clang__) // TRANSITION, LLVM-48606
...
#else // ^^^ defined(__cpp_lib_concepts) && !defined(__clang__) / !defined(__cpp_lib_concepts) || defined(__clang__) vvv
