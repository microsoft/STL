...
_EXPORT_STD enum class errc { // names for generic error codes
    ...
    no_message_available _CXX23_DEPRECATE_UNIX_STREAM = 120, // ENODATA
    no_message                                        = 122, // ENOMSG
    no_protocol_option                                = 123, // ENOPROTOOPT
    no_space_on_device                                = 28, // ENOSPC
    no_stream_resources _CXX23_DEPRECATE_UNIX_STREAM  = 124, // ENOSR
    ...
    not_a_stream _CXX23_DEPRECATE_UNIX_STREAM         = 125, // ENOSTR
    ...
    stream_timeout _CXX23_DEPRECATE_UNIX_STREAM       = 137, // ETIME
