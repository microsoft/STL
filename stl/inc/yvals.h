...
#if _STL_WIN32_WINNT >= _STL_WIN32_WINNT_WINBLUE
#define _STD_ATOMIC_ALWAYS_USE_CMPXCHG16B 1
#else // ^^^ _STL_WIN32_WINNT >= _STL_WIN32_WINNT_WINBLUE // _STL_WIN32_WINNT < _STL_WIN32_WINNT_WINBLUE vvv
...
#error ARM64 requires _STD_ATOMIC_ALWAYS_USE_CMPXCHG16B
